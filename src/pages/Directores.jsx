                ...
                <tbody>
                    {listaDirectores.map(item =>
                        <tr key={item.iddirector}
                            onMouseEnter={(event)=>event.currentTarget.classList.add("mostrarIconos")}
                            onMouseLeave={(event)=>event.currentTarget.classList.remove("mostrarIconos")}>
                            ...
                            <td><i className="bi bi-x-lg icono-eliminar" title="Eliminar"
